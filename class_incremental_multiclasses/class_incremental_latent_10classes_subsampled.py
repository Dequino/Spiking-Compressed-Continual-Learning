...
for c in range(10, 20):
    ...
    csv = open("latent_10classes_incremental_csv_depth%d_batches%d_subsampled.csv" % (latent_depth, latent_batches), "a")
    ...
    latent_data_x_continual, latent_data_y_continual = generate_latent_subsample(x_batches_continual_train, y_batches_continual_train, latent_depth, latent_batches)
